...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("28/06/2019"), "Partiu viagem", "Vou viajar para o Rio de Janeiro. Abraços!", gabi);
		Post post2 = new Post(null, sdf.parse("30/06/2019"), "Bom dia!", "Acordei feliz hoje!", gabi);
